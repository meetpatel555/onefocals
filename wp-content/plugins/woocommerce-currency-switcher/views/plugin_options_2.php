            ...
            <?php if ($WOOCS->notes_for_free): ?>
                ...
                <?php if (time() < 1764676740): ?>
                    ...
                    <a href="https://codecanyon.pluginus.net/item/woocommerce-currency-switcher/8085217" style="position: absolute;
                       ...
                       align-items: center;
                       line-height: 29px;
                       "target="_blank" class=""><img src="https://pluginus.net/wp-content/uploads/2025/11/DiscountBanner_ItemPreviewBanner_Launch_616x215_50__x2.png" width="120" alt="Cybermonday AND Blackfriday" /></a>
                   <?php else: ?>
