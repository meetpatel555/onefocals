...
// Header Section.
$wp_customize->add_section( 'omega_jewelry_store_social_media_setting',
	array(
...
$wp_customize->add_setting( 'omega_jewelry_store_header_layout_facebook_link',
    array(
    'default'           => $omega_jewelry_store_default['omega_jewelry_store_header_layout_facebook_link'],
    'capability'        => 'edit_theme_options',
...
$wp_customize->add_control( 'omega_jewelry_store_header_layout_facebook_link',
    ...
    'section'  => 'omega_jewelry_store_social_media_setting',
    'type'     => 'url',
    )
);
...
$wp_customize->add_setting( 'omega_jewelry_store_header_layout_twitter_link',
    array(
    'default'           => $omega_jewelry_store_default['omega_jewelry_store_header_layout_twitter_link'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'esc_url_raw',
    )
);
...
$wp_customize->add_setting( 'omega_jewelry_store_header_layout_pintrest_link',
    array(
    'default'           => $omega_jewelry_store_default['omega_jewelry_store_header_layout_pintrest_link'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'esc_url_raw',
    )
);
...
$wp_customize->add_setting( 'omega_jewelry_store_header_layout_instagram_link',
    array(
    'default'           => $omega_jewelry_store_default['omega_jewelry_store_header_layout_instagram_link'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'esc_url_raw',
    )
);
...
$wp_customize->add_setting( 'omega_jewelry_store_header_layout_youtube_link',
    array(
    'default'           => $omega_jewelry_store_default['omega_jewelry_store_header_layout_youtube_link'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'esc_url_raw',
    )
);
