...
function omega_jewelry_store_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'colors' )->panel = 'omega_jewelry_store_theme_colors_panel';
	$wp_customize->get_section( 'colors' )->title = esc_html__('Color Options','omega-jewelry-store');
	$wp_customize->get_section( 'title_tagline' )->panel = 'omega_jewelry_store_theme_general_settings';
	$wp_customize->get_section( 'header_image' )->panel = 'omega_jewelry_store_theme_general_settings';
	$wp_customize->get_section( 'background_image' )->panel = 'omega_jewelry_store_theme_general_settings';
	...
	$wp_customize->add_panel( 'omega_jewelry_store_theme_general_settings',
		array(
	...
	$wp_customize->add_panel( 'omega_jewelry_store_theme_colors_panel',
		array(
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'omega_jewelry_store_theme_footer_option_panel',
		array(
	...
	// Template Options
	$wp_customize->add_panel( 'omega_jewelry_store_theme_home_pannel',
		array(
		...
		// Theme Addons Panel.
	$wp_customize->add_panel( 'omega_jewelry_store_theme_addons_panel',
		array(
			'title'      => esc_html__( 'Theme Addons', 'omega-jewelry-store' ),
			'priority'   => 5,
			'capability' => 'edit_theme_options',
		)
	);
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'omega_jewelry_store_theme_option_panel',
		array(
	...
	$wp_customize->add_setting('omega_jewelry_store_logo_width_range',
	    array(
	        'default'           => $omega_jewelry_store_default['omega_jewelry_store_logo_width_range'],
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'omega_jewelry_store_sanitize_number_range',
	    )
	);
	$wp_customize->add_control('omega_jewelry_store_logo_width_range',
	    array(
	...
	$wp_customize->add_section(
		new omega_jewelry_store_Customize_Section_Upsell(
			...
			array(
				...
				'pro_url'  => esc_url('https://www.omegathemes.com/products/jewelry-store-wordpress-theme'),
				'priority'  => 1,
			)
		)
	);
	...
	$wp_customize->add_section(
		new omega_jewelry_store_Customize_Section_Upsell(
			...
			'theme_upsell_bundle',
			array(
				'title'    => esc_html__( 'Buy WP Theme Bundle', 'omega-jewelry-store' ),
				'pro_text' => esc_html__( 'Get Bundle', 'omega-jewelry-store' ),
